...
const neutralDigit = Array(6).fill({ hour: 10, minute: 50 });
...
function setHands(id, hour, minute) {//a remplacer dans arduino
...
function setTime(time) {
  console.log(digits[time.charAt(0)]);
...
function setTemp(temp) {
  console.log(digits[temp.charAt(0)]);
  setDigit(0, digits[temp.charAt(0)]);
  setDigit(1, digits[temp.charAt(1)]);
  setDigit(2,digitsTemp[0]);
  setDigit(3,digitsTemp[1]);
  //setDigit(2, digits[temp.charAt(3)]);
  //setDigit(3, digits[temp.charAt(4)]);
}
